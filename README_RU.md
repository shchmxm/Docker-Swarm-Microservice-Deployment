...
Проект демонстрирует развертывание микросервисного Java Spring Boot-приложения в Docker Swarm кластере из трёх виртуальных машин. Для каждого микросервиса написан Dockerfile, и итоговые образы контейнеров загружены в Docker Hub.
